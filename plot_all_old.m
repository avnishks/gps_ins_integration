...
figure(3)
subplot(3,1,1)
plot(lla_true(:,2)/0.01745329,lla_true(:,1)/0.01745329,lla_calc(:,2),lla_calc(:,1),'LineWidth',1)
grid on
xlabel('Longitude (in degrees)')
ylabel('Latitude (in degrees)')
axis auto
subplot(3,1,2)
plot(t_flight,lla_true(:,1)/0.01745329-lla_calc(:,1),'LineWidth',2)
grid on
xlabel('Time (in Seconds)')
ylabel('Error in Latitude (in degrees)')
axis auto
subplot(3,1,3)
plot(t_flight,lla_true(:,2)/0.01745329-lla_calc(:,2),'LineWidth',2)
grid on
xlabel('Time (in Seconds)')
...
figure(103)
plot(lla_true(:,2)/0.01745329,lla_true(:,1)/0.01745329,lla_calc(:,2),lla_calc(:,1),'LineWidth',2)
grid on
xlabel('Longitude (in degrees)')
ylabel('Latitude (in degrees)')
